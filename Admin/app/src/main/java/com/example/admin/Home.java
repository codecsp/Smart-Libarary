...
import com.example.admin.ViewHolder.MenuViewHolder;
...
import static com.example.admin.Common.Common.*;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtfullname=(TextView)headerview.findViewById(R.id.txtfullnames);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent=new Intent(Home.this,BookIssued.class);
            startActivity(intent);

        }
        else if (id == R.id.nav_return_book)
        {
            Intent intent=new Intent(Home.this,returnBook.class);
            startActivity(intent);
        ...
        else if (id == R.id.nav_logout)
        {
            ...
            Intent signin=new Intent(Home.this, com.example.admin.signin.class);
